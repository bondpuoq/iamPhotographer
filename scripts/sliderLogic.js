...
Muse.Utils.allStyleSheetRulesFromOneSheet = function (a, b) {
    var c = !1, d; try { d = a.cssRules } catch (g) { } if (!d) c = !0, d = a.rules; if (!d) return null; for (var f = [], j = $(window), h = function (a) {
        if (4 != a.type || 1 != a.media.length) return !1; var b = j.data("muse-mq"); if (!b) return !1; if (a.media[0] == b) return !0; if (a.media.mediaText && 0 <= a.media.mediaText.indexOf(b.replace(/\s/g, ""))) return !0; if (a.media.mediaText && (a = a.media.mediaText.replace(/\sand\s/g, "__and__").replace(/\s/g, "").split("__and__"), b = b.replace(/\sand\s/g, "__and__").replace(/\s/g,
            "").split("__and__"), a && a.sort && b && b.sort)) { "all" == a[0] && a.splice(0, 1); a.sort(); b.sort(); if (a.length != b.length) return !1; for (var c = 0; c < a.length; c++)if (a[c] != b[c]) return !1; return !0 } return !1
    }, i = 0; i < d.length; ++i) { var k = d[i]; if (h(k)) { if (k = Muse.Utils.allStyleSheetRulesFromOneSheet(k, b), null != k) for (var l = 0; l < k.length; l++)f.push(k[l]) } else if (Muse.Utils.isDefined(k.selectorText)) if (c) b(k.selectorText) && f.push(k); else for (var l = k.selectorText.split(/\s*,\s*/), m = 0; m < l.length; m++)b(l[m]) && f.push(k) } return f.length ?
        f : null
}; Muse.Utils.getRuleProperty = function (a, b) { if (a && a.length) { for (var c = a.length - 1; c >= 0; c--) { var d = Muse.Utils.getRuleProperty(a[c], b); if (d) return d } return "" } if (a.style.getPropertyValue) return a.style.getPropertyValue(b); return a.style.getAttribute(b) }; Muse.Utils.toCamelCase = function (a) { for (var b = Muse.Utils.toCamelCase.exp; b.test(a); a = a.replace(b, RegExp.$1.toUpperCase())); return a }; Muse.Utils.toCamelCase.exp = /-([a-z])/;
...
Muse.Utils.processHyperlink = function (a) {
    var b = a.href, c = $(window), a = $(a), d = a.attr("target"); if (!d || d == "_self") {
        var g = b.lastIndexOf("/"), d = b.lastIndexOf("#"), f = a.attr("class").match(/anim_(\w+)/); if (f && d > g) {
            var a = c.data("scrollWrapper"), j = b.substring(d), d = Muse.Utils.getAnchorWithDestination(j).offset(), b = f[1], h = a || window, g = document.documentElement || document.body, f = (a ? a.scrollHeight() : g.scrollHeight) - c.height(), c = (a ? a.scrollWidth() : g.scrollWidth) - c.width(), i = Math.min(f, d.top + (a && !a.isStandard() ? a.scrollTop() :
                0)), k = Math.min(c, d.left + (a && !a.isStandard() ? a.scrollLeft() : 0)), c = function () { h.scrollTo(k, i); try { history.replaceState({}) } catch (a) { if (!jQuery.browser.msie || jQuery.browser.version > 7) window.location.hash = j } }; try { history.pushState({}, null, j) } catch (l) { } if (window.scrollTo || void 0 !== a) { var a = a || $(document), m = a.scrollLeft(), o = a.scrollTop(), r = m, p = o; $({ scrollDistance: 0 }).animate({ scrollDistance: 1 }, { duration: 1E3, easing: b, step: function (a) { a != 0 && (p = a * (i - o), r = a * (k - m), h.scrollTo(m + r, o + p)) }, complete: c }) } else $("html,body").animate({
                    scrollTop: i,
                    scrollLeft: k
                }, 1E3, b, c); return !1
        }
    } (c = Muse.Utils.urlParam(b, "devicelock")) && Muse.Utils.createCookie("devicelock", c, 0); return !0
}; var actionStack = []; Muse.Utils.redirectCancelled = !1; Muse.Utils.redirectHyperlink = function (a) { if (Muse.Utils.redirectCancelled) setTimeout(function () { Muse.Utils.redirectCancelled = !1 }, 0); else if (actionStack = [], Muse.Utils.processHyperlink(a) && !Muse.Utils.isIBE()) { var b = $(a).attr("target"); b || (b = "_self"); window.open(a.href, b) } };
Muse.Utils.redirectHyperlinkInNewTab = function (a, b) { if (Muse.Utils.redirectCancelled) setTimeout(function () { Muse.Utils.redirectCancelled = !1 }, 0); else { actionStack = []; thisWindow = window.self; var c = window.open(a); b ? c.focus() : thisWindow.focus() } }; Muse.Utils.isMouseLeftClick = function (a) { return a.which == 1 }; Muse.Utils.isMouseMiddleClick = function (a) { return a.which == 2 }; Muse.Utils.isRedirectLinkKeyboardAction = function (a) { return a.which == 13 };
Muse.Utils.addHyperlinkAnchor = function (a) {
    a = $(a); a.bind("mousedown", function (a) { (Muse.Utils.isMouseLeftClick(a) || Muse.Utils.isMouseMiddleClick(a)) && actionStack.push(this) }); a.bind("mouseup keyup", function (a) {
        if (Muse.Utils.isMouseLeftClick(a) && actionStack.indexOf(this) != -1) a.ctrlKey || a.metaKey ? Muse.Utils.redirectHyperlinkInNewTab(this.href, a.shiftKey) : Muse.Utils.redirectHyperlink(this); else if (Muse.Utils.isMouseMiddleClick(a) && actionStack.indexOf(this) != -1) if (jQuery.browser.webkit || !a.target.href &&
            jQuery.browser.msie) Muse.Utils.redirectHyperlinkInNewTab(this.href, a.shiftKey); else return actionStack = [], !0; else Muse.Utils.isRedirectLinkKeyboardAction(a) && Muse.Utils.redirectHyperlink(this); return !1
    }); Muse.Utils.isIBE() || a.bind("click", function () { return !1 })
};
Muse.Utils.addHyperlinkBlock = function (a) {
    var b = $(a.parentNode); b.bind("mousedown", function (a) { (Muse.Utils.isMouseLeftClick(a) || Muse.Utils.isMouseMiddleClick(a)) && actionStack.push(this); return !1 }); b.bind("mouseup keyup", function (b) {
        Muse.Utils.isMouseLeftClick(b) && actionStack.indexOf(this) != -1 ? b.ctrlKey || b.metaKey ? Muse.Utils.redirectHyperlinkInNewTab(a.href, b.shiftKey) : Muse.Utils.redirectHyperlink(a) : Muse.Utils.isMouseMiddleClick(b) && actionStack.indexOf(this) != -1 ? Muse.Utils.redirectHyperlinkInNewTab(a.href,
            b.shiftKey) : Muse.Utils.isRedirectLinkKeyboardAction(b) && Muse.Utils.redirectHyperlink(a); return !1
    }); Muse.Utils.isIBE() || b.bind("click", function () { return !1 })
};
Muse.Utils.prepHyperlinks = function (a) {
    $("a.block").each(function () { var a = $(this.parentNode); Muse.Utils.addHyperlinkBlock(this); a.find("a.nonblock").each(function () { var a = $(this); if (a.data("registeredNonBlockLink") === !0) return !1; Muse.Utils.addHyperlinkAnchor(this); a.data("registeredNonBlockLink", !0) }) }); $("a.nonblock").each(function () {
        var a = $(this); a.data("registeredNonBlockLink") !== !0 && (a.parent('[class~="sbg"]').length > 0 ? Muse.Utils.addHyperlinkAnchor(this) : (a.attr("class").match(/anim_(\w+)/) || this.href.indexOf("devicelock=") !=
            -1) && $(this).bind("click", function () { return Muse.Utils.processHyperlink(this) }))
    }); a && Muse.Utils.enableAnchorLinksActiveState()
}; Muse.Utils.pathOnly = function (a) { if (!a) return a; return a.replace(/#(?:[^#]+)$/, "").replace(/\?(?:[^\?]+)$/, "") };
Muse.Utils.enableAnchorLinksActiveState = function () {
    var a = !1, b = [], c = $(window), d = Muse.Utils.getPageStyleSheets(), g = function (a) { var b = a.parent('[class~="sbg"]'); if (a.hasClass("MenuItem") || b.hasClass("MenuItem")) return "MuseMenuActive"; if (a.hasClass("Button") || b.hasClass("Button")) return "ButtonSelected"; return "MuseLinkActive" }, f = !1, j = function (c) {
        b.splice(0, b.length); $("a.nonblock,a.block", c).each(function () { Muse.Utils.saveHyperlinkInfo($(this), g($(this)), d, a, b) }); b.sort(function (a, b) {
            if (a.from < b.from) return -1;
            if (a.from > b.from) return 1; return 0
        }); f = !0
    }, h = !1, i = c.data("scrollWrapper"), k = i || c, l = null, m = function () {
        h = !1; if (!f) { var c = $("#page"); a = c.outerWidth() / c.outerHeight() > 2; j(l) } var c = a ? k.scrollLeft() : k.scrollTop(), d; a: { var o = 0; d = b.length; for (var m; o < d; o++)if (m = b[o], m.from <= c && c <= m.to) { d = o; break a } d = -1 } var q, y, o = Math.max(0, d); for (d = Math.min(d + 2, b.length); o < d; o++)if (q = b[o], m = q.$elem.offset().left + (i && !i.isStandard() ? i.scrollLeft() : 0), y = q.$elem.offset().top + (i && !i.isStandard() ? i.scrollTop() : 0), q.from != (a ? m :
            y)) { j(l); break } o = 0; for (d = b.length; o < d; o++) { q = b[o]; m = q.from <= c && c <= q.to; q = q.hyperLinks; y = void 0; for (var C = 0; C < q.length; C++)y = g(q[C]), m && !q[C].hasClass(y) ? q[C].addClass(y) : !m && q[C].hasClass(y) && q[C].removeClass(y) }
    }, o = function () { h || (h = !0, Muse.Utils.requestAnimationFrame(m)) }; (i = c.data("scrollWrapper")) ? i.registerUpdateCallback(o) : c.scroll(o); $("body").on("muse_bp_activate", function (a, b, c) { f = !1; l = c; o() }); 0 == $(".breakpoint").length && m()
};
...
Muse.Utils.getNaturalWidth = function (a) {
    var b = -1; a.naturalWidth != null ? b = a.naturalWidth : a.runtimeStyle ? (a.runtimeStyle.width = "auto", a.runtimeStyle.height = "auto", a.runtimeStyle.borderWidth = "0", a.runtimeStyle.padding = "0", b = a.offsetWidth, a.runtimeStyle.width = "", a.runtimeStyle.height = "", a.runtimeStyle.borderWidth = "", a.runtimeStyle.padding = "") : (a = a.cloneNode(!0), a.className = "", a.style.width = "auto !important", a.style.height = "auto !important", a.style.borderWidth = "0 !important", a.style.padding = "0 !important",
        b = a.width); return b
};
Muse.Utils.getNaturalHeight = function (a) {
    var b = -1; a.naturalHeight != null ? b = a.naturalHeight : a.runtimeStyle ? (a.runtimeStyle.width = "auto", a.runtimeStyle.height = "auto", a.runtimeStyle.borderWidth = "0", a.runtimeStyle.padding = "0", b = a.offsetHeight, a.runtimeStyle.width = "", a.runtimeStyle.height = "", a.runtimeStyle.borderWidth = "", a.runtimeStyle.padding = "") : (a = a.cloneNode(!0), a.className = "", a.style.width = "auto !important", a.style.height = "auto !important", a.style.borderWidth = "0 !important", a.style.padding = "0 !important",
        b = a.height); return b
}; Muse.Utils.pieLoading = !1; Muse.Utils.pieFunctionQueue = [];
...
Muse.Utils.addRoundedCorners = function () {
    $(".rounded-corners").each(function () {
        var a = this; Muse.Utils.needPIE(function () {
            var b = $(a); if (!b.data("mu-ie-matrix")) {
                var c = b.css("filter"); if (!c || !(c.toLowerCase().indexOf("opacity") > 0 && c.indexOf("=100") < 0)) {
                    if (a.childNodes.length && !Muse.Browser.Features.checkCSSFeature("border-radius") && (c = Muse.Utils.firstChild(a, Muse.Utils.Match.byNodeName("img"))) && c.nodeName.toLowerCase() == "img") {
                        ...
                        if (f == "0px" || f == "auto") f = c.css("padding-left"); var j = c.css("margin-top"); if (j == "0px" || j == "auto") j = c.css("padding-top"); if ((f == "0px" || f == "auto") && (j == "0px" || j == "auto")) b.addClass("museBGSize"), b.css("background-size", "cover"); c.css("visibility", "hidden"); b.css("background", g + "url(" + d + ") no-repeat " + f + " " + j)
                    } PIE.attach(a)
                }
            }
        })
    })
}; Muse.Utils.addRGBA = function () { $(".rgba-background").each(function () { var a = this; Muse.Utils.needPIE(function () { PIE.attach(a) }) }) };
...
Muse.Utils.fixTransformRotations = function () {
    Muse.Browser.Features.checkCSSFeature("transform") || $("*[data-mu-ie-matrix]").each(function () {
        var a = $(this), b = a.parent(), c = Math.round(a.data("mu-ie-matrix-dx")), d = Math.round(a.data("mu-ie-matrix-dy")), g = b.innerHeight(), f = b.innerWidth(); a.css({ filter: function (b, c) { if (c) return c + " " + a.data("mu-ie-matrix"); return a.data("mu-ie-matrix") }, "margin-bottom": "-=" + d }).removeClass("shadow"); b.css({
            "margin-bottom": "-=" + (b.innerHeight() - g), "margin-right": "-=" + (b.innerWidth() -
                f)
        }); a.hasClass("actAsDiv") ? (a.wrap('<span class="actAsDiv rotateWrapper"></span>'), a.parent().css("float", a.css("float"))) : a.hasClass("actAsInlineDiv") ? a.wrap('<span class="actAsInlineDiv rotateWrapper"></span>') : a.wrap('<div class="rotateWrapper"></div>'); a.parent().css({ top: d, left: c, position: "relative", "margin-bottom": d })
    })
};
...
Muse.Utils.initWidget = function (a, b, c) {
    if (0 == $(".breakpoint").length) $(a).each(function () { c($(this)) }); else {
        for (var d = 0; d < b.length; d++) { var g = b[d]; if (!Muse.Utils._initWidgetQueue) Muse.Utils._initWidgetQueue = {}; Muse.Utils._initWidgetQueue[g] || (Muse.Utils._initWidgetQueue[g] = []); Muse.Utils._initWidgetQueue[g].push({ id: a, fn: c }) } if (Muse.Utils._initWidgetQueue && !Muse.Utils._hasBPListener) {
            var f = function (a, b, c, d) {
                a = c.attr("id"); Muse.Assert.assert(a, "Invalid breakpoint node - missing the ID attribute"); a =
                    "#" + a; if (Muse.Utils._initWidgetQueue[a]) { for (; Muse.Utils._initWidgetQueue[a].length;)if (b = Muse.Utils._initWidgetQueue[a].shift(), b = b.fn($(b.id, c))) b.$bp = c, b.breakpoint = d; Muse.Utils.showWidgetsWhenReady(c); delete Muse.Utils._initWidgetQueue[a]; var c = !0, g; for (g in Muse.Utils._initWidgetQueue) { c = !1; break } if (c) $("body").off("muse_bp_activate", f), Muse.Utils._hasBPListener = !1 }
            }; $("body").on("muse_bp_activate", f); Muse.Utils._hasBPListener = !0
        }
    }
};
...
Muse.Utils.detachIframesAndObjectsToPauseMedia = function (a) {
    var b = [], c = []; $("iframe, object", a).each(function () {
        var a = $(this); if (!a.is("object") || !(jQuery.browser.msie && jQuery.browser.version < 9)) {
            if (a.is("iframe")) { var g = a.prop("src"); if ("" == g || !g || !g.indexOf) return; if (0 <= g.indexOf("vimeo.com")) { Muse.Utils.VimeoVideoHelper.pause(a); c.push({ $node: a, playFn: function (a) { Muse.Utils.VimeoVideoHelper.seekTo(a, 0); Muse.Utils.VimeoVideoHelper.isAutoPlay(a) && Muse.Utils.VimeoVideoHelper.play(a) } }); return } } g = {};
            g.$next = a.next(); g.$parent = a.parent(); jQuery.browser.msie ? (g.html = a.wrap('<div id="deleteMeWrapper"/>').parent().html(), a.remove(), g.$parent.children("div #deleteMeWrapper").remove()) : (g.$node = a.clone(), a.remove()); b.push(g)
        }
    }); b.length && a.data("detached", b); c.length && a.data("paused", c); $("video", a).each(function () {
        if (jQuery.browser.msie && jQuery.browser.version == 9 && this.pause && this.getAttribute("autoplay") && this.readyState != 4) $(this).one("play", function () { this.pause() }); else this.pause && !this.paused &&
            this.pause()
    })
};
Muse.Utils.attachIframesAndObjectsToResumeMedia = function (a) {
    var b = a.data("detached"); if (b) { for (var c = b.length - 1; c >= 0; c--) { var d = b[c]; !d.$next || d.$next.length == 0 ? d.$parent.append(d.$node ? d.$node : d.html) : d.$next.before(d.$node ? d.$node : d.html); d.$next = d.$parent = d.$node = d.html = void 0 } a.data("detached", null) } if (b = a.data("paused")) for (c = 0; c < b.length; c++)d = b[c], d.playFn(d.$node); $("iframe", a).each(function () { var a = $(this), b = a.attr("src"), c = a.data("src"); "about:blank" == b && c && a.attr("src", c) }); $("video", a).each(function () {
        if (this.play &&
            this.getAttribute("autoplay") && this.paused) this.currentTime = 0, this.play()
    })
};
Muse.Utils.VimeoVideoHelper = function (a) {
    var b = [], c = function (a, b) { if (!0 == a.data("isReady")) b(); else { var c = a.data("readyQueue"); c || (c = []); c.push(b); a.data("readyQueue", c) } }, d = function (a, c, f, d) { var g = a[0].contentWindow; d && b.push({ source: g, method: c, callbackFn: d }); c = '"method": "' + c + '"'; "undefined" != typeof f && null !== f && (c += '"value":"' + f + '"'); g.postMessage("{" + c + "}", a.data("origin")) }, g = function (b) {
        data = null; JSON && JSON.parse && (data = JSON.parse(b.data)); var c = null; data && data.player_id && (c = a("#" + data.player_id));
        (!c || !c.length) && a("iframe").each(function () { if (this.contentWindow == b.source) return c = a(this), !1 }); return c
    }, f = function (a) { var c = JSON.parse(a.data); if (c) { if ("ready" == c.event) { var f = g(a); f.data("isReady", !0); f.data("origin", a.origin); var d = f.data("readyQueue"); if (d && d.length) for (var l = 0; l < d.length; l++)d[l](); f.data("readyQueue", null) } for (l = 0; l < b.length;)f = b[l], f.source == a.source && f.method == c.method ? (f.callbackFn(c.value), b.splice(l, 1)) : l++ } }; window.addEventListener ? window.addEventListener("message",
...
(function (a) {
    a(window); var b = a("html"), c = ["src"], d = ["hidpi-src", "src"], g = a(".hidpi_button"), f = function () { this._mode = "standard" }; f.swapSources = function (a, b, c) { var f = a.attr("data-" + b); f && !("src" == b && a.hasClass("ImageInclude") && a.attr("src").indexOf("images/blank.gif") == a.attr("src").length - 16 && a.parents(".SlideShowWidget").length) && ("src" == c && !a.attr("data-" + c) && a.attr("data-" + c, a.attr("src")), a.attr("src", f)) }; f.isRetina = function () {
        ...
        return !1
    }(); f.shouldUseCookie = 0 < g.length; f.getResolutionPreference = function () { return Muse.Utils.readCookie("museresolution") }; f.saveResolutionPreference = function (a) { Muse.Utils.createCookie("museresolution", a) }; f.prototype.initializeHiDPIButton = function (b) {
        if (f.isRetina) {
            var c = this; g.filter(function () { return !a(this).data("initialized") }).each(function () { a(this).data("initialized", !0) }).removeClass("unavailable").click(function () {
                switch (c._mode) {
...
Muse.Browser.Features.Touch = function () {
    if (navigator.maxTouchPoints > 0 || window.matchMedia && window.matchMedia("(-moz-touch-enabled)").matches) return { Start: "pointerDown", End: "pointerUp", Move: "pointerMove", Listener: function (a) { return function (b) { var c = b.originalEvent || b; if (c.pointerType != c.POINTER_TYPE_MOUSE) return a.apply(this, arguments) } } }; else for (var a = 0, b = Muse.Browser.domPrefixes.length; a < b; a++) {
        var c = Muse.Browser.domPrefixes[a]; if (c + "MaxTouchPoints" in navigator && navigator[c + "MaxTouchPoints"]) return c =
            c.toUpperCase(), { Start: c + "PointerDown", End: c + "PointerUp", Move: c + "PointerMove", Listener: function (a) { return function (b) { var d = b.originalEvent || b; if (d.pointerType != d[c + "POINTER_TYPE_MOUSE"]) return a.apply(this, arguments) } } }
    } try { return document.createEvent("TouchEvent"), { Start: "touchstart", End: "touchend", Move: "touchmove", Listener: function (a) { return a } } } catch (d) { } return !1
}();
...
Muse.Browser.Bugs.ClearNeedsOuterWidth = function () {
    var a = document.createElement("div"); a.id = "mbbcnow00"; a.innerHTML = '<div>a</div><style type="text/css">#mbbcnow00{position:absolute;top:-9999px;left:-9999px;visibility:hidden;} #mbbcnow01{width:1px;margin-right:-9999px;float:left} #mbbcnow02{clear:left;}</style>'; var b = document.createElement("div"), c = document.createElement("div"); document.body.appendChild(a); a.appendChild(b); a.appendChild(c); b.innerHTML = "a"; b.id = "mbbcnow01"; c.innerHTML = "b"; c.id = "mbbcnow02";
    b = c.getBoundingClientRect().top - b.getBoundingClientRect().top; document.body.removeChild(a); return b < 1
...
})(jQuery); Muse.Utils.requestAnimationFrame = function () { return window.mozRequestAnimationFrame && window.mozRequestAnimationFrame.bind(window) || window.requestAnimationFrame && window.requestAnimationFrame.bind(window) || window.webkitRequestAnimationFrame && window.webkitRequestAnimationFrame.bind(window) || function (a) { window.setTimeout(a, 20) } }();
...
; (function () { if (!("undefined" == typeof Muse || "undefined" == typeof Muse.assets)) { var a = function (a, b) { for (var c = 0, d = a.length; c < d; c++)if (a[c] == b) return c; return -1 }(Muse.assets.required, "sliderLogic.js"); if (-1 != a) { Muse.assets.required.splice(a, 1); for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) { var d = a[b]; if ("generator" == d.getAttribute("name")) { "2015.1.2.344" != d.getAttribute("content") && Muse.assets.outOfDate.push("sliderLogic.js"); break } } } } })();
